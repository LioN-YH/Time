...
| `experiment_summaries/visual_router_v2_round2/` | Visual Router V2 Round 2 轻量协议与 summary 目录 | 当前包含 `round2_small_screening_protocol.md`、`small_samples/` 和 `layout_imageization_smoke/`；记录 view layout small screening 样本协议、layout candidate registry、top3fold 复用审计、Round2b layout imageization smoke 的 CSV/JSON/Markdown 和少量 debug thumbnails；不包含 feature cache、checkpoint、ViT embedding 或大规模伪图像 tensor |
