...
| `experiment_summaries/visual_router_v2_round2/` | Visual Router V2 Round 2 轻量协议与 summary 目录 | 当前包含 `round2_small_screening_protocol.md` 和 `small_samples/`；本轮只记录 view layout small screening 样本协议、layout candidate registry、top3fold 复用审计、validation、coverage、metadata 和中文摘要，不包含 feature cache、checkpoint、ViT embedding 或伪图像 tensor |
