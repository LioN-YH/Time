...
| `time_router/features/__init__.py` | 共享特征适配器子包入口 | 导出 P7a 最小 `TimeFuseFeatureCacheProvider`、P14b smoke-only `VisualMockFeatureProvider` 和 `DeterministicVisualEncoderStub`；当前只用于 smoke，不接正式 TimeFuse fusor / Visual Router 入口 |
