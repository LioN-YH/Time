...
| `time_router/evaluation/__init__.py` | 共享评估子包入口 | 导出 P3a/P3b/P3c/P3d 最小 fusion/metrics/router weight diagnostics/summary/rows helper，以及 P6b `FusionEvaluator` smoke-only adapter；当前不包含 calibration、正式报告 schema 或训练入口迁移 |
