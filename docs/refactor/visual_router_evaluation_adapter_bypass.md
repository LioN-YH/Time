...
P9c 已完成小规模正式入口 pressure 验证，详见
`docs/refactor/visual_router_evaluation_adapter_pressure_verification.md`。验证结论是：
关闭和开启 `--verify-evaluation-adapter` 后，除 run_dir 路径和生成时间外，正式
