...
P11a 已冻结 future canonical run artifact schema；下一步应先审计真实 full-scale Visual labels
schema 与 TimeFuse feature/oracle schema，再冻结 `SampleManifest` 物理存储格式，并在 P11c
设计最小 Runtime artifact writer 接入边界，最后准备 small / pressure / full-scale scripts。
