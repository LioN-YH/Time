...
下一步应先审计真实 full-scale Visual labels schema 与 TimeFuse feature/oracle schema，再冻结
`SampleManifest` 物理存储格式、run artifact schema，并准备 small / pressure / full-scale scripts。
